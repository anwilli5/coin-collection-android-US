    ...
    public static final CollectionListInfo[] COLLECTION_LIST_INFO_SCENARIOS =
            {
                    ...
                    new CollectionListInfo("Clad Quarters", 653, 0, getIndexFromCollectionClass(CladQuarters.class), 0, 0, 0, "2255", "9007199254863872"),
                    new CollectionListInfo("Silver Quarters", 235, 0, getIndexFromCollectionClass(SilverQuarters.class), 0, 0, 0, "15", "4536584976211968"),
                    ...
                    new CollectionListInfo("Silver Half Dollars", 245, 0, getIndexFromCollectionClass(SilverHalfDollars.class), 0, 1892, 2023, "4383", "2251799876599841"),
                    ...
                    new CollectionListInfo("Cartwheels", 271, 0, getIndexFromCollectionClass(Cartwheels.class), 0, 1878, 2023, "383", "18014527358500897"),
                    ...
                    new CollectionListInfo("Kennedy Half Dollars", 231, 0, getIndexFromCollectionClass(KennedyHalfDollars.class), 0, 1964, 2023, "2439", "2286984185774121"),
                    new CollectionListInfo("Roosevelt Dimes", 287, 0, getIndexFromCollectionClass(RooseveltDimes.class), 0, 1946, 2023, "2511", "1161084278931497"),
