    ...
    public static final CollectionListInfo[] COLLECTION_LIST_INFO_SCENARIOS =
            {
                    ...
                    new CollectionListInfo("American_Women", 45, 0, getIndexFromCollectionClass(AmericanWomenQuarters.class), 0, 0, 0, "15", "0"),
                    ...
                    new CollectionListInfo("Clad Quarters", 614, 0, getIndexFromCollectionClass(CladQuarters.class), 0, 0, 0, "2383", "122880"),
                    new CollectionListInfo("Washington Silver", 225, 0, getIndexFromCollectionClass(WashingtonSilver.class), 0, 0, 0, "15", "32985348841472"),
                    new CollectionListInfo("Early Quarters", 244, 0, getIndexFromCollectionClass(EarlyQuarters.class), 0, 1796, 1930, "63", "6753"),
                    new CollectionListInfo("Small Dollars", 206, 0, getIndexFromCollectionClass(SmallDollars.class), 0, 0, 0, "143", "962072674304"),
