...
public class StateQuarters extends CollectionInfo {
    ...
    public int getCoinSlotImage(String identifier, String mint, Boolean inCollection){
        return STATES_INFO.get(identifier)[inCollection ? 0 : 1];
    }
    ...
    public void getCreationParameters(HashMap<String, Object> parameters) {
        ...
        parameters.put(CoinPageCreator.SHOW_TERRITORIES, Boolean.TRUE);
    }
    ...
    public void populateCollectionArrays(HashMap<String, Object> parameters,
        ...
        Boolean showTerritories = (Boolean) parameters.get(CoinPageCreator.SHOW_TERRITORIES);
