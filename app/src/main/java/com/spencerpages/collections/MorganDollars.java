        ...
        for (int i = startYear; i <= stopYear; i++) {
            ...
            if (showMintMarks) {
                if (showP) {
                    ...
                    } else if (i != 1895) {coinList.add(new CoinSlot(year, "", coinIndex++));}
                }
                if (showD) {
                    if (i == 1921) {coinList.add(new CoinSlot(year, "D", coinIndex++));}
                }
                if (showO) {
                    if (i != 1878 && i != 1921) {coinList.add(new CoinSlot(year, "O", coinIndex++));}
                }
                if (showCC) {
                    if (i != 1886 && i != 1887 && i != 1888 && i <= 1893) {coinList.add(new CoinSlot(year, "CC", coinIndex++));}
                }
                if (showS) {coinList.add(new CoinSlot(year, "S", coinIndex++));}
            } else {
